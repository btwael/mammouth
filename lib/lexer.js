...
(function() {
  ...
  KEYWORDS = {
    ...
    LOGIC: ['and', 'or', 'xor'],
    RESERVED: ['as', 'break', 'by', 'catch', 'case', 'clone', 'const', 'continue', 'cte', 'declare', 'delete', 'echo', 'else', 'finally', 'for', 'func', 'goto', 'if', 'in', 'instanceof', 'loop', 'new', 'not', 'null', 'of', 'return', 'switch', 'then', 'throw', 'try', 'unless', 'until', 'use', 'when', 'while'],
