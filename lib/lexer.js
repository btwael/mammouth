  ...
  Lexer = (function() {
    ...
    Lexer.prototype.readTokenIdentifier = function() {
      ...
      if (indexOf.call(KEYWORDS.RESERVED, value) >= 0) {
        ...
        if ((value === 'if' || value === 'unless') && !((ref1 = this.last().type) === 'INDENT' || ref1 === 'MINDENT' || ref1 === 'OUTDENT' || ref1 === '(' || ref1 === 'CALL_START' || ref1 === ',' || ref1 === 'ELSE')) {
    ...
    Lexer.prototype.skipComments = function() {
      var value;
