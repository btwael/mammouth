...
(function() {
  ...
  Lexer = (function() {
    ...
    Lexer.prototype.readTokenIdentifier = function() {
      var indentTracker, length, ref, ref1, res, token, value;
      token = (new Token).setStart(this.getPos());
  ...
  KEYWORDS = {
    ...
    COMPARE: ['is', 'isnt'],
    LOGIC: ['and', 'or', 'xor'],
    RESERVED: ['as', 'by', 'catch', 'clone', 'const', 'cte', 'else', 'finally', 'for', 'func', 'if', 'in', 'instanceof', 'loop', 'new', 'not', 'null', 'of', 'then', 'try', 'unless', 'until', 'use', 'when', 'while'],
