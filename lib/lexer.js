  ...
  Lexer = (function() {
    ...
    Lexer.prototype.nextToken = function() {
      if (!this.Track.into.mammouth) {
        return this.addToken(this.readRAW());
      }
      ...
      if (this.isIdentifier(this.pos)) {
        return this.addToken(this.readTokenIdentifier());
      }
      return this.addToken(this.getTokenFromCode(this.input.charCodeAt(this.pos)));
    };
