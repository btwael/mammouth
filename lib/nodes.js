...
(function() {
  ...
  Class = exports.Class = (function() {
    function Class(name1, body1, extendable, implement, modifier) {
      this.name = name1;
      this.body = body1;
      this.extendable = extendable != null ? extendable : false;
      this.implement = implement != null ? implement : false;
      this.modifier = modifier != null ? modifier : false;
      this.type = "Class";
    }
  ...
  ClassLine = exports.ClassLine = (function() {
    function ClassLine(visibility, statically, element1) {
