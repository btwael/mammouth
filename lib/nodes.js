...
(function() {
  var Access, Array, ArrayKey, Assign, BlankLine, Block, Bool, BreakStatement, Call, Code, Constant, ContinueStatement, EchoStatement, Existence, Expression, Identifier, If, IncludeStatement, Literal, MammouthBlock, Operation, Parens, PassingIdentifier, PlainBlock, RequireStatement, ReturnStatement, Try, Unary, Update, Value, While;
  ...
  exports.Identifier = Identifier = (function() {
    function Identifier(name, as_arguments) {
      this.name = name;
