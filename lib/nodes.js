...
(function() {
  var Access, Array, ArrayKey, Assign, Base, Block, Break, Call, Class, ClassLine, Clone, Code, Constant, Context, Continue, Declare, Delete, Document, Echo, Else, ElseIf, Existence, Expression, For, GetKeyAssign, Goto, HereDoc, Identifier, If, Include, Interface, Literal, Namespace, NewExpression, Operation, Param, Parens, QualifiedName, Range, RawText, Require, Return, Script, Section, Slice, Switch, Throw, Try, Unary, Update, Value, While, typeCasting,
  ...
  Call = exports.Call = (function(superClass) {
    ...
    Call.prototype.compile = function(system) {
      ...
      if (this.callee.value.type === 'Existence') {
    ...
    For.prototype.compile = function(system) {
      ...
      if (this.isStatement) {
        ...
        if ((this.source.range != null) && this.source.range === true) {
          index = this.source.index != null ? this.source.index : system.context.free('i');
          code += 'for(';
  ...
  Switch = exports.Switch = (function(superClass) {
    ...
    Switch.prototype.prepare = function() {
      var j, lastndex, len1, ref, ref1, whe;
      ref = this.whens;
      for (j = 0, len1 = ref.length; j < len1; j++) {
        whe = ref[j];
        whe[1].expands = true;
        ...
        if (!((ref1 = whe[1].body[lastndex].type) === 'Return' || ref1 === 'Break')) {
    ...
    Switch.prototype.compile = function(system) {
      var code, i, j, k, len1, len2, ref, ref1, val, whe;
      code = '';
