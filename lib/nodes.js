...
(function() {
  var Access, Array, ArrayKey, Assign, Block, Break, Call, Clone, Code, Constant, Continue, Declare, Delete, Document, Echo, Else, ElseIf, Existence, For, GetKeyAssign, Goto, Identifier, If, Literal, NewExpression, Operation, Param, Parens, Range, RawText, Return, Script, Section, Slice, Switch, Throw, Try, Unary, Update, Value, While, typeCasting;
